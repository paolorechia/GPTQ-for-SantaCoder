...
qlayer = QuantLinear(
    2, -1, layer.in_features, layer.out_features, layer.bias is not None, kernel_switch_threshold=False, is_cuda=True
)
...
qlayer = QuantLinear(
    3, -1, layer.in_features, layer.out_features, layer.bias is not None, kernel_switch_threshold=False, is_cuda=True
)
qlayer.pack(layer, quantizer.scale, quantizer.zero)
...
qlayer = QuantLinear(
    4, -1, layer.in_features, layer.out_features, layer.bias is not None, kernel_switch_threshold=False, is_cuda=True
)
qlayer.pack(layer, quantizer.scale, quantizer.zero)
...
qlayer = QuantLinear(
    8, -1, layer.in_features, layer.out_features, layer.bias is not None, kernel_switch_threshold=False, is_cuda=True
)
qlayer.pack(layer, quantizer.scale, quantizer.zero)
