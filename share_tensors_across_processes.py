...
def load_checkpoint_shared_and_dispatch(
    model, checkpoint, device_map="auto", max_memory=None, no_split_module_classes=None
):  # **kwparams):
    try:
        with open(f"{checkpoint}.shared", "rb") as shared:
            ...
            with tqdm.tqdm(
                ...
                state_dict = {
                    name: rebuild_tensor(*tensor_params) for name, (rebuild_tensor, tensor_params) in shared_tensors
                }
